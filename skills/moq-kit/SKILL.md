...
**Requirements:** iOS 16+ / macOS 13+ (Xcode 26+ to build) / Android minSdk 29, compileSdk 35. A moq-lite relay to connect to. The references cover iOS and Android; macOS is declared by the Swift package but untested here.
