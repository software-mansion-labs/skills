...
| File                                         | When to read                                                                                       |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `references/view-application-logs.md`        | Debugging any app issue — call `view_application_logs` first for build, bundling, and runtime logs |
| `references/view-screenshot.md`              | Inspecting the current visual state of the app                                                     |
...
| `references/view-network-logs.md`            | Inspecting network requests — paginated list of all HTTP traffic                                   |
